  ...
  return (
    <section className="dados-root">
      ...
      <style jsx>{`
        ...
        .dados-tabs button, .dados-rapidos button, .dados-modos button { min-height: 40px; border: 1px solid #d8d8d8; border-radius: 999px; background: #fff; color: #111 !important; -webkit-text-fill-color: #111 !important; padding: 0 18px; font-weight: 800; cursor: pointer; -webkit-appearance: none; appearance: none; }
        .dados-tabs button.active, .dados-rapidos button.active, .dados-modos button.active { background: #050505; border-color: #050505; color: #fff !important; -webkit-text-fill-color: #fff !important; }
        ...
        .dados-filtros select { width: 100%; min-height: 44px; border: 1px solid #d8d8d8; border-radius: 12px; background: #fff; color: #8d6b12 !important; -webkit-text-fill-color: #8d6b12 !important; padding: 0 12px; }
